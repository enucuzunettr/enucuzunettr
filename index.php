      ...
      **/
                  ...
                  if ( $order->get_status() != 'completed'){
                     ...
                     if ( $_POST['x_response_code'] == 1 ){
                        ...
                        if ( $order->get_status() == 'processing' ){
                            ...
                            $order->add_order_note('Authorize.net payment successful<br/>Ref Number/Transaction ID: '.$_REQUEST['x_trans_id']);
      ...
      public function web_redirect($url){
         ...
         echo "<html><head><script language=\"javascript\">
                ...
                </head><body><noscript><meta http-equiv=\"refresh\" content=\"0;url={$url}\"></noscript>REDIRECTING...</body></html>";
